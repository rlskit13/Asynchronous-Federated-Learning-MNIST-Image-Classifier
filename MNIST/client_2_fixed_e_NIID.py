...
Directory = "C:\\Users\\z5278080\\Fritz_FL_demo\\MNIST\\Models\\Client_2"
...
def train_NIID_dataset(dataset):
    idx = []
    limit = 0
    for i in range(10):
        if i < 5: 
...
datasets = train_NIID_dataset(dataset)

# n_epoch == local training rounds, must be even number
while n_epochs <= 20:
